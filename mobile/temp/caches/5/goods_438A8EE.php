<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:67:"C:/www/0123s.bzncp/mobile/themesmobile/68ecshopcom_mobile/goods.dwt";i:1;s:77:"C:/www/0123s.bzncp/mobile/themesmobile/68ecshopcom_mobile/library/up_menu.lbi";i:2;s:83:"C:/www/0123s.bzncp/mobile/themesmobile/68ecshopcom_mobile/library/goods_gallery.lbi";i:3;s:78:"C:/www/0123s.bzncp/mobile/themesmobile/68ecshopcom_mobile/library/comments.lbi";}s:7:"expires";i:1489733571;s:8:"maketime";i:1489729971;}<!DOCTYPE html >
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width">
<title>精品促销 葡萄 泽山巨峰 _水果_水果蔬菜_1236农产品  </title>
...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="精品促销 葡萄 泽山巨峰 ">
            <input type="hidden" name="pics" value="../images/201612/goods_img/342_G_1481766972649.jpg">
            <input type="hidden" name="gid" value="342">
            <input type="hidden" name="url" value="http://bzncp.0123s.cc/mobile/goods.php?id=342">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201612/goods_img/342_P_1481766972496.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(342)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">精品促销 葡萄 泽山巨峰</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥0.00元</span><font>价格：￥80.00元</font>                                </dt>
                            </dl>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=342" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
    ...
    <h2 style=" border-bottom:1px solid #ddd ">
      ...
      <ul class="xiangq">
                                            <li><p>上架时间：</p><span>2016-12-15</span><li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:342;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(342,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(342)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(342);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(342)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 342;
