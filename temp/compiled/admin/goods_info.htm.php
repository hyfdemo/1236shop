								...
								<table width="400" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_24205300_1481015930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_24205300_1481015930']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_24205300_1481015930']['name_p'] >= "a" && $this->_var['brand_list_0_24205300_1481015930']['name_p'] <= "g"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_24205300_1481015930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_24205300_1481015930']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_24205300_1481015930']['name']; ?>')"><?php echo $this->_var['brand_list_0_24205300_1481015930']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_24238700_1481015930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_24238700_1481015930']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_24238700_1481015930']['name_p'] >= "h" && $this->_var['brand_list_0_24238700_1481015930']['name_p'] <= "k"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_24238700_1481015930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_24238700_1481015930']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_24238700_1481015930']['name']; ?>')"><?php echo $this->_var['brand_list_0_24238700_1481015930']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_24260400_1481015930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_24260400_1481015930']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_24260400_1481015930']['name_p'] >= "l" && $this->_var['brand_list_0_24260400_1481015930']['name_p'] <= "s"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_24260400_1481015930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_24260400_1481015930']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_24260400_1481015930']['name']; ?>')"><?php echo $this->_var['brand_list_0_24260400_1481015930']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_24280000_1481015930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_24280000_1481015930']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_24280000_1481015930']['name_p'] >= "t" && $this->_var['brand_list_0_24280000_1481015930']['name_p'] <= "z"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_24280000_1481015930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_24280000_1481015930']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_24280000_1481015930']['name']; ?>')"><?php echo $this->_var['brand_list_0_24280000_1481015930']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_24299900_1481015930');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_24299900_1481015930']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_24299900_1481015930']['name_p'] >= "0" && $this->_var['brand_list_0_24299900_1481015930']['name_p'] <= "9"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_24299900_1481015930']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_24299900_1481015930']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_24299900_1481015930']['name']; ?>')"><?php echo $this->_var['brand_list_0_24299900_1481015930']['name']; ?></a>
												</div>
											</div>
...
?>
			...
			<!--代码修改_start By www.hongyuvip.com  将 商品相册 这部分代码完全修改成下面这样-->
...
?>
			...
			<div class="button-div">
				...
				<!--修改代码_start By www.hongyuvip.com 主要是给这两个INPUT各自增加了一个ID， id="goods_info_submit"  id="goods_info_reset" -->
