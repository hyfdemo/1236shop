...
<!--隐藏lw	  <tr>
	  ...
	  <tr>
        ...
        <td><input type="radio" name="show_in_index" value="1" <?php if ($this->_var['cat_info']['show_in_index'] == '1'): ?>checked=checked<?php endif; ?> >
          显示
          <input type="radio" name="show_in_index" value="0" <?php if (! $this->_var['cat_info']['show_in_index']): ?>checked=checked<?php endif; ?>>
          不显示 <br>
